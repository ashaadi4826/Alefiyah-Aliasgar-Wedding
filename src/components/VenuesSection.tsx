      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="space-y-7 sm:space-y-9">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="p-6 sm:p-9 rounded-3xl bg-[#EFE3D5]/70 border border-[#D4AF7A] shadow-[0_8px_24px_-6px_rgba(91,26,36,0.08)] relative overflow-hidden text-center"
          >
            ...
            <div className="text-center">
              <span className="text-xs font-heading-caps px-3.5 py-1 rounded-full bg-[#FAF4ED] border border-[#D4AF7A] text-[#7A2837] font-bold uppercase tracking-wider inline-block mb-3">
                Family Residence
              </span>
              ...
              <div className="p-4 rounded-2xl bg-[#FAF4ED] border border-[#D4AF7A] max-w-md mx-auto mb-5 text-center space-y-0.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            {VENUES.map((venue, index) => (
              <motion.div
                ...
                className="p-6 sm:p-8 rounded-3xl bg-[#EFE3D5]/70 border border-[#D4AF7A] shadow-[0_8px_24px_-6px_rgba(91,26,36,0.08)] flex flex-col justify-between relative overflow-hidden"
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-3">
                    ...
                    {venue.note && (
                      <span className="text-[10px] font-heading-caps px-2.5 py-1 rounded-full bg-[#FAF4ED] border border-[#D4AF7A] text-[#7A2837] font-bold uppercase tracking-wider text-right">
                        {venue.note}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mb-5 p-3 rounded-2xl bg-[#FAF4ED] border border-[#D4AF7A]/80">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {venue.associatedEvents.map((evt) => (
                        <span
                          key={evt}
                          className="text-xs px-2 py-0.5 rounded-lg bg-[#EFE3D5] border border-[#D4AF7A] text-[#451019] font-bold shadow-2xs"
                        >
                          {evt}
                        </span>
                      ))}
