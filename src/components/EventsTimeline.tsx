  ...
  return (
    <section id="events" className="py-16 sm:py-24 px-4 relative overflow-hidden paper-texture">
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        ...
        {/* Continuous Soft Pastel Stationery Cards */}
          ...
          {WEDDING_EVENTS.map((event, index) => {
            ...
            return (
              <motion.div
                ...
                className="w-full"
              >
                <div className="p-6 sm:p-9 rounded-3xl bg-[#FAF5EE]/90 border border-[#D4AF7A] shadow-[0_8px_24px_-6px_rgba(91,26,36,0.08)] text-center flex flex-col items-center relative overflow-hidden backdrop-blur-2xs">
                  {/* Subtle top emblem */}
                  ...
                  {event.description && (
                    <div className="w-full max-w-md mb-4 px-4 py-3 rounded-2xl bg-[#FFFDF9] border border-[#D4AF7A]/70 text-center">
                  ...
                  <div className="w-full max-w-md mb-3 flex flex-col items-center justify-center gap-1.5 p-3.5 rounded-2xl bg-[#FFFDF9] border border-[#D4AF7A]">
                  ...
                  {event.processionTime && event.majlisTime ? (
                    <div className="w-full max-w-md mb-2.5 p-3 rounded-2xl bg-[#FFFDF9] border border-[#D4AF7A]/80 flex flex-col sm:flex-row items-center justify-center gap-2.5 sm:gap-6">
                    ...
                    <div className="w-full max-w-md mb-2.5 p-3 rounded-2xl bg-[#FFFDF9] border border-[#D4AF7A]/80 flex items-center justify-center gap-2.5">
                      <div className="w-8 h-8 rounded-lg bg-[#FAF4ED] border border-[#D4AF7A] flex items-center justify-center text-[#6B1B29] shrink-0 shadow-2xs">
                        <Clock className="w-4 h-4" />
                      </div>
                  ...
                  {/* 6. VENUE */}
                  <div className="w-full max-w-md p-3 rounded-2xl bg-[#FFFDF9] border border-[#D4AF7A]/80 flex items-center justify-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-[#FAF4ED] border border-[#D4AF7A] flex items-center justify-center text-[#6B1B29] shrink-0 shadow-2xs">
