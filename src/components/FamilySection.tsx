        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-7 sm:gap-9">
          {FAMILY_DATA.map((family, idx) => (
            <motion.div
              ...
              className="p-6 sm:p-9 rounded-3xl bg-[#EFE3D5]/70 border border-[#D4AF7A] shadow-[0_8px_24px_-6px_rgba(91,26,36,0.08)] relative overflow-hidden flex flex-col justify-between"
            >
              {/* Top Crest */}
              ...
              <div>
                ...
                <div className="text-center pb-4 mb-4 border-b border-[#D4AF7A]/60">
                  <span className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-[#FAF4ED] border border-[#D4AF7A] text-[#7A2837] text-xs font-heading-caps font-bold uppercase tracking-wider mb-2">
